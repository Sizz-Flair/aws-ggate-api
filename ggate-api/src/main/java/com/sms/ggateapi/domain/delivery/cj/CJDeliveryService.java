...
import com.sms.ggateapi.domain.delivery.cj.dto.ReportLabelDto;
...
public class CJDeliveryService implements DeliveryService {
    ...
    public String getZipCode(@NonNull String... data) {
        ...
        try {
            return Objects.requireNonNull(cjApiFacade.callZipCode(orderNo, address)
                    .map(zip ->
